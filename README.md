...
# Voting System
A simple and secure web-based voting application built using React Native and Firebase.
It allows users to vote for candidates, prevents duplicate voting, and displays live vote counts dynamically.
